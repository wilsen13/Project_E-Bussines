...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10" x-data="{ isRemote: {{ old('is_remote') ? 'true' : 'false' }} }">
    ...
    <form action="{{ route('jobs.store') }}" method="POST" enctype="multipart/form-data" class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
        @csrf
        ...
        <div class="p-8 space-y-5">
            ...
            <div>
                ...
                <input type="text" id="title" name="title" value="{{ old('title') }}" required class="w-full px-4 py-3 rounded-xl border border-gray-300 focus:ring-2 focus:ring-blue-600 focus:border-blue-600 transition-all bg-gray-50 focus:bg-white" placeholder="Contoh: Desain Logo Kedai Kopi">
            ...
            <div>
                ...
                <textarea id="description" name="description" rows="5" required class="w-full px-4 py-3 rounded-xl border border-gray-300 focus:ring-2 focus:ring-blue-600 focus:border-blue-600 transition-all bg-gray-50 focus:bg-white" placeholder="Jelaskan secara detail apa yang harus dilakukan pekerja...">{{ old('description') }}</textarea>
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="number" id="payAmount" name="payAmount" value="{{ old('payAmount') }}" required min="0" class="w-full pl-12 pr-4 py-3 rounded-xl border border-gray-300 focus:ring-2 focus:ring-blue-600 focus:border-blue-600 transition-all bg-gray-50 focus:bg-white" placeholder="150000">
                </div>
            ...
            <div>
                ...
                <div class="relative">
                    <div id="dropZone" class="border-2 border-dashed border-gray-300 hover:border-blue-400 rounded-2xl p-6 text-center transition-all duration-200 cursor-pointer bg-gray-50 hover:bg-blue-50/50 min-h-[180px] flex items-center justify-center">
                        ...
                        <div id="previewContainer" class="hidden relative w-full">
        ...
        <div class="p-8 border-t border-gray-100 space-y-5">
            ...
            <div x-show="!isRemote" x-transition.duration.300ms class="space-y-4 p-5 border border-gray-200 rounded-xl bg-gray-50/70">
                ...
                <div>
                    ...
                    <input type="text" id="addressLine" name="addressLine" value="{{ old('addressLine') }}" :required="!isRemote" class="w-full px-4 py-3 rounded-xl border border-gray-300 focus:ring-2 focus:ring-blue-600 focus:border-blue-600 transition-all bg-white">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" id="city" name="city" value="{{ old('city') }}" :required="!isRemote" class="w-full px-4 py-3 rounded-xl border border-gray-300 focus:ring-2 focus:ring-blue-600 focus:border-blue-600 transition-all bg-white">
                        @error('city') <p class="mt-1 text-sm text-red-600">{{ $message }}</p> @enderror
                    </div>
                    <div>
                        <label for="province" class="block text-sm font-semibold text-gray-700 mb-1">Provinsi</label>
                        <input type="text" id="province" name="province" value="{{ old('province') }}" :required="!isRemote" class="w-full px-4 py-3 rounded-xl border border-gray-300 focus:ring-2 focus:ring-blue-600 focus:border-blue-600 transition-all bg-white">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    dropZone.addEventListener('click', function(e) {
        if (e.target.closest('#removeImageBtn')) return; // Don't open picker when clicking remove
        fileInput.click();
    });
